...
describe('Autolinker.js UMD file in browser', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, page.goto("file://" + __dirname + "/test-browser-umd.html", {
                            waitUntil: 'load'
                        })];
                case 3:
                    _a.sent();
    ...
    it('should have the `window.Autolinker` global, and Autolinker should work', function () { return __awaiter(_this, void 0, void 0, function () {
        var innerHTML;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should expose `Autolinker.matcher.Matcher` so that it can be extended', function () { return __awaiter(_this, void 0, void 0, function () {
        var typeofMatcher;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, page.evaluate(function () {
                        return typeof window.Autolinker.matcher.Matcher;
                    })];
                case 1:
                    typeofMatcher = _a.sent();
