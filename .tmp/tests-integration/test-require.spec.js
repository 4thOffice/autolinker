...
var NamedAutolinker = require('autolinker').Autolinker;
describe('Autolinker require() tests - ', function () {
    ...
    it("AnchorTagBuilder should be a top-level named export of 'autolinker'", function () {
    ...
    it("The 'Match' classes should be top-level named exports of 'autolinker' (as of v2.0)", function () {
    ...
    it("The 'Match' classes should also continue to be in their 1.x namespace locations for backward compatibility", function () {
    ...
    it("The 'Matcher' classes should be top-level named exports of 'autolinker' (as of v2.0)", function () {
    ...
    it("The 'Matcher' classes should also continue to be in their 1.x namespace locations for backward compatibility", function () {
