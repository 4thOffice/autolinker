...
describe("Autolinker Url Matching -", function () {
    ...
    describe("protocol-prefixed URLs (i.e. URLs starting with http:// or https://)", function () {
        ...
        it("should automatically link 'yahoo.xyz' (a known TLD), but not 'sencha.etc' (an unknown TLD)", function () {
            var result = autolinker.link("yahoo.xyz should be linked, sencha.etc should not");
        ...
        it("should automatically link 'a.museum' (a known TLD), but not 'abc.123'", function () {
            var result = autolinker.link("a.museum should be linked, but abc.123 should not");
        ...
        it("should automatically link URLs with periods in the path", function () {
            var result1 = autolinker.link('https://images-na.ssl-images-amazon.com/images/I/912ozjp0ytL._SY450_.jpg');
            ...
            var result2 = autolinker.link('My image is at: https://images-na.ssl-images-amazon.com/images/I/912ozjp0ytL._SY450_.jpg - check it out');
    ...
    describe("square bracket handling", function () {
        it("when the url is surrounded by square brackets, it should not include \n\t\t\t should not include the final closing bracket in the URL", function () {
            var result = autolinker.link("Click here [google.com] for more details");
            expect(result).toBe('Click here [<a href="http://google.com">google.com</a>] for more details');
        });
        ...
        it("should include escaped brackets in the URL", function () {
            var result = autolinker.link("Here's an example from CodingHorror: http://en.wikipedia.org/wiki/PC_Tools_%5BCentral_Point_Software%5D");
        ...
        it("should correctly accept square brackets such as PHP array \n\t\t     representation in query strings", function () {
            var result = autolinker.link("Here's an example: http://www.example.com/foo.php?bar[]=1&bar[]=2&bar[]=3");
    ...
    describe('combination example', function () {
        it("should automatically link all of the URLs of many different forms", function () {
