...
describe("Autolinker", function () {
    describe("instantiating and using as a class", function () {
        it("should configure the instance with configuration options, and then be able to execute the link() method", function () {
            var autolinker = new autolinker_1.default({ newWindow: false, truncate: 25 });
    ...
    describe("config checking", function () {
        describe("no configs", function () {
            it("should default to the default options if no `cfg` object is provided (namely, `newWindow: true`)", function () {
                expect(autolinker_1.default.link("Welcome to google.com")).toBe('Welcome to <a href="http://google.com" target="_blank" rel="noopener noreferrer">google.com</a>');
            });
        });
        describe("`hashtag` cfg", function () {
            it("should throw if `hashtag` is a value other than `false` or one of the valid service names", function () {
                expect(function () {
                    new autolinker_1.default({ hashtag: true }); // `true` is an invalid value - must be a service name
                }).toThrowError("invalid `hashtag` cfg - see docs");
                expect(function () {
                    new autolinker_1.default({ hashtag: 'non-existent-service' });
                }).toThrowError("invalid `hashtag` cfg - see docs");
            });
            it("should not throw for the valid service name 'twitter'", function () {
                expect(function () {
                    new autolinker_1.default({ hashtag: 'twitter' });
                }).not.toThrow();
            });
            it("should not throw for the valid service name 'facebook'", function () {
                expect(function () {
                    new autolinker_1.default({ hashtag: 'facebook' });
                }).not.toThrow();
            });
            it("should not throw for the valid service name 'instagram'", function () {
                expect(function () {
                    new autolinker_1.default({ hashtag: 'instagram' });
                }).not.toThrow();
            });
        });
        describe('`mention` cfg', function () {
            it("should throw if `mention` is a value other than `false` or one of the valid service names", function () {
                expect(function () {
                    new autolinker_1.default({ mention: true }); // `true` is an invalid value - must be a service name
                }).toThrowError("invalid `mention` cfg - see docs");
                expect(function () {
                    new autolinker_1.default({ mention: 'non-existent-service' });
                }).toThrowError("invalid `mention` cfg - see docs");
            });
            it("should not throw for the valid service name 'twitter'", function () {
                expect(function () {
                    new autolinker_1.default({ mention: 'twitter' });
                }).not.toThrow();
            });
            it("should not throw for the valid service name 'instagram'", function () {
                expect(function () {
                    new autolinker_1.default({ mention: 'instagram' });
                }).not.toThrow();
            });
        });
    });
    describe("link() method", function () {
        ...
        beforeEach(function () {
            autolinker = new autolinker_1.default({ newWindow: false }); // so that target="_blank" is not added to resulting autolinked URLs
            twitterAutolinker = new autolinker_1.default({ mention: 'twitter', newWindow: false });
        });
        ...
        describe("proper handling of HTML in the input string", function () {
            ...
            it("when unquoted anchor href's exist, should NOT automatically link the text inside", function () {
                var result = autolinker.link('<p>Joe went to <a href=http://www.yahoo.com>yahoo</a></p>');
                expect(result).toBe('<p>Joe went to <a href=http://www.yahoo.com>yahoo</a></p>');
                var result2 = autolinker.link('<p>Joe went to <a href=http://www.yahoo.com?query=1>yahoo</a></p>');
            ...
            it("should not fail with an infinite loop for an input string with " +
                "completely invalid HTML (issue #160)", function () {
                var result = autolinker.link('<US_Con_SL_RTNS@dell.com\n' +
            ...
            it("should not fail with an infinite loop for an input string with " +
                "marginally valid HTML (issue #157)", function () {
            ...
            it("should not fail with an infinite loop for an input string with " +
                "a string that looks like HTML (Issue #172)", function () {
                var str = '<Office%20days:%20Tue.%20&%20Wed.%20(till%2015:30%20hr),%20Thu.%20(till%2017:30%20hr),%20Fri.%20(till%2012:30%20hr).%3c/a%3e%3cbr%3e%3c/td%3e%3ctd%20style=>', result = autolinker.link(str);
                expect(result).toBe(str);
            });
            it("should not fail with a Maximum Call Stack Size Exceeded for an " +
                "input with a large number of html entities (Issue #171)", function () {
            ...
            it("should attempt to handle some more complex invalid HTML markup relating to <a> tags, esp if there are extraneous closing </a> tags", function () {
                ...
                expect(result).toBe([
                    '</a>',
                    '<a href="http://google.com">google.com</a>',
                    '<div><a href="http://google.com">google.com</a></div>',
                    '</a>',
                    '<a href="http://yahoo.com">yahoo.com</a>',
                    '</a>',
                    '</a>',
        ...
        describe("HTML entity character handling", function () {
            it("should handle an HTML entity at the beginning of the string", function () {
                var result = autolinker.link('&amp;now go to google.com');
        ...
        describe("`newWindow` option", function () {
            it("should not add target=\"_blank\" when the 'newWindow' option is set to false", function () {
                var result = autolinker_1.default.link("Test http://url.com", { newWindow: false });
            ...
            it("should add target=\"_blank\" and rel=\"noopener noreferrer\" when the 'newWindow' option is set to true (see https://mathiasbynens.github.io/rel-noopener/ about the 'rel' attribute, which prevents a potential phishing attack)", function () {
                var result = autolinker_1.default.link("Test http://url.com", { newWindow: true });
        ...
        describe("`stripPrefix` option", function () {
            it("should not remove the prefix for non-http protocols", function () {
                var result = autolinker_1.default.link("Test file://execute-virus.com", { stripPrefix: true, newWindow: false });
            ...
            it("should remove 'http://www.' when the 'stripPrefix' option is set to `true`", function () {
                var result = autolinker_1.default.link("Test http://www.url.com", { stripPrefix: true, newWindow: false });
            ...
            it("should not remove 'http://www.' when the 'stripPrefix' option is set to `false`", function () {
                var result = autolinker_1.default.link("Test http://www.url.com", { stripPrefix: false, newWindow: false });
            ...
            it('should leave the original text as-is when the `stripPrefix` option is `false`', function () {
                var result1 = autolinker_1.default.link('My url.com', { stripPrefix: false, newWindow: false });
                expect(result1).toBe('My <a href="http://url.com">url.com</a>');
                var result2 = autolinker_1.default.link('My www.url.com', { stripPrefix: false, newWindow: false });
                expect(result2).toBe('My <a href="http://www.url.com">www.url.com</a>');
                var result3 = autolinker_1.default.link('My http://url.com', { stripPrefix: false, newWindow: false });
                expect(result3).toBe('My <a href="http://url.com">http://url.com</a>');
                var result4 = autolinker_1.default.link('My http://www.url.com', { stripPrefix: false, newWindow: false });
                expect(result4).toBe('My <a href="http://www.url.com">http://www.url.com</a>');
            });
            it("should remove the prefix by default", function () {
                var result = autolinker_1.default.link("Test http://www.url.com", { newWindow: false });
                expect(result).toBe('Test <a href="http://www.url.com">url.com</a>');
            });
            it("when stripPrefix `scheme` is true, but `www` is false, it should " +
                "only strip the scheme", function () {
                var result = autolinker_1.default.link("Test http://www.url.com", {
            ...
            it("when stripPrefix `scheme` is false, but `www` is true for a " +
                "scheme-only URL, it should not strip anything", function () {
                var result = autolinker_1.default.link("Test http://url.com", {
                    stripPrefix: { scheme: false, www: true },
                    newWindow: false
                });
            ...
            it("when stripPrefix `scheme` is false, but `www` is true for a " +
                "'www'-only URL, it should strip the 'www'", function () {
                var result = autolinker_1.default.link("Test www.url.com", {
                    stripPrefix: { scheme: false, www: true },
                    newWindow: false
                });
                expect(result).toBe('Test <a href="http://www.url.com">url.com</a>');
            ...
            it("when stripPrefix `scheme` is true and `www` is true, it should " +
                "strip the entire prefix (scheme and 'www')", function () {
                var result = autolinker_1.default.link("Test http://www.url.com", {
        ...
        describe("`stripTrailingSlash` option", function () {
            it("by default, should remove the trailing slash", function () {
                var result = autolinker_1.default.link("http://google.com/", {
                    stripPrefix: false,
        ...
        describe("`decodePercentEncoding` option", function () {
            it("by default, should decode percent-encoding", function () {
                var result = autolinker_1.default.link("https://en.wikipedia.org/wiki/San_Jos%C3%A9", {
                    stripPrefix: false,
        ...
        describe("`truncate` option", function () {
            describe('number form', function () {
                it("should not perform any truncation if the `truncate` option is not passed in", function () {
                    var result = autolinker_1.default.link("Test http://url.com/with/path", { newWindow: false });
                ...
                it("should not perform any truncation if `truncate` is 0", function () {
                    var result = autolinker_1.default.link("Test http://url.com/with/path", { truncate: 0, newWindow: false });
                    expect(result).toBe('Test <a href="http://url.com/with/path">url.com/with/path</a>');
                });
                it("should truncate long a url/email/twitter to the given number of characters with the 'truncate' option specified", function () {
                    var result = autolinker_1.default.link("Test http://url.com/with/path", { truncate: 12, newWindow: false });
                ...
                it("should leave a url/email/twitter alone if the length of the url is exactly equal to the length of the 'truncate' option", function () {
                    var result = autolinker_1.default.link("Test http://url.com/with/path", { truncate: 'url.com/with/path'.length, newWindow: false }); // the exact length of the link
                    expect(result).toBe('Test <a href="http://url.com/with/path">url.com/with/path</a>');
                });
                it("should leave a url/email/twitter alone if it does not exceed the given number of characters provided in the 'truncate' option", function () {
                    var result = autolinker_1.default.link("Test http://url.com/with/path", { truncate: 25, newWindow: false }); // just a random high number
                    expect(result).toBe('Test <a href="http://url.com/with/path">url.com/with/path</a>');
                });
            });
            describe('object form (with `length` and `location` properties)', function () {
                it("should not perform any truncation if `truncate.length` is not passed in", function () {
                    var result = autolinker_1.default.link("Test http://url.com/with/path", { truncate: { location: 'end' }, newWindow: false });
                    expect(result).toBe('Test <a href="http://url.com/with/path">url.com/with/path</a>');
                });
                it("should not perform any truncation if `truncate.length` is 0", function () {
                    var result = autolinker_1.default.link("Test http://url.com/with/path", { truncate: { length: 0 }, newWindow: false });
                    expect(result).toBe('Test <a href="http://url.com/with/path">url.com/with/path</a>');
                });
                it('should default the `location` to "end" if it is not provided', function () {
                    var result = autolinker_1.default.link("Test http://url.com/with/path", { truncate: { length: 12 }, newWindow: false });
                    expect(result).toBe('Test <a href="http://url.com/with/path" title="http://url.com/with/path">url.com/w&hellip;</a>');
                });
                it('should truncate at the end when `location: "end"` is specified', function () {
                    var result = autolinker_1.default.link("Test http://url.com/with/path", { truncate: { length: 12, location: 'end' }, newWindow: false });
                    expect(result).toBe('Test <a href="http://url.com/with/path" title="http://url.com/with/path">url.com/w&hellip;</a>');
                });
                it('should truncate in the middle when `location: "middle"` is specified', function () {
                    var result = autolinker_1.default.link("Test http://url.com/with/path", { truncate: { length: 12, location: 'middle' }, newWindow: false });
                ...
                it('should truncate according to the "smart" truncation rules when `location: "smart"` is specified', function () {
                    var result = autolinker_1.default.link("Test http://url.com/with/path", { truncate: { length: 12, location: 'smart' }, newWindow: false });
        ...
        describe("`className` option", function () {
            it("should not add className when the 'className' option is not a string with at least 1 character", function () {
                var result = autolinker_1.default.link("Test http://url.com", { newWindow: false });
                expect(result).toBe('Test <a href="http://url.com">url.com</a>');
                result = autolinker_1.default.link("Test http://url.com", { newWindow: false, className: null });
                expect(result).toBe('Test <a href="http://url.com">url.com</a>');
                result = autolinker_1.default.link("Test http://url.com", { newWindow: false, className: "" });
                expect(result).toBe('Test <a href="http://url.com">url.com</a>');
            });
            it("should add className to links", function () {
                var result = autolinker_1.default.link("Test http://url.com", { newWindow: false, className: 'myLink' });
            ...
            it("should add className to email links", function () {
                var result = autolinker_1.default.link("Iggy's email is mr@iggypop.com", { newWindow: false, email: true, className: 'myLink' });
            ...
            it("should add className to twitter links", function () {
                var result = autolinker_1.default.link("hi from @iggypopschest", { newWindow: false, mention: 'twitter', className: 'myLink' });
            ...
            it("should add className to mention links", function () {
                var result = autolinker_1.default.link("hi from @iggypopschest", { newWindow: false, mention: 'twitter', className: 'myLink' });
                expect(result).toBe('hi from <a href="https://twitter.com/iggypopschest" class="myLink myLink-mention myLink-twitter">@iggypopschest</a>');
                result = autolinker_1.default.link("hi from @iggypopschest", { newWindow: false, mention: 'instagram', className: 'myLink' });
        ...
        describe('`urls` option', function () {
            ...
            it('should link all 3 types if the `urls` option is `true`', function () {
                var result = autolinker_1.default.link(str, { newWindow: false, stripPrefix: false, urls: true });
                expect(result).toBe([
            ...
            it('should not link any of the 3 types if the `urls` option is `false`', function () {
                var result = autolinker_1.default.link(str, { newWindow: false, stripPrefix: false, urls: false });
                expect(result).toBe([
                    'http://google.com',
                    'www.google.com',
                    'google.com'
            ...
            it('should only link scheme URLs if `schemeMatches` is the only `urls` option that is `true`', function () {
                var result = autolinker_1.default.link(str, { newWindow: false, stripPrefix: false, urls: {
                        schemeMatches: true,
                        wwwMatches: false,
                        tldMatches: false
                    } });
        ...
        describe("`urls` (as boolean), `email`, `phone`, `twitter`, and `mention` options", function () {
            ...
            it("should link all 5 types if all 5 urls/email/phone/mention/hashtag options are enabled", function () {
                var result = autolinker_1.default.link(inputStr, {
                    hashtag: 'twitter',
                    mention: 'twitter',
                    newWindow: false
                });
            ...
            it("should link mentions based on value provided to mention option", function () {
                var result = autolinker_1.default.link(inputStr, { newWindow: false, hashtag: 'twitter', mention: 'twitter' });
                expect(result).toBe([
                    'Website: <a href="http://asdf.com">asdf.com</a>',
                    'EmailMatch: <a href="mailto:asdf@asdf.com">asdf@asdf.com</a>',
                    'Phone: <a href="tel:1234567890">(123) 456-7890</a>',
                ...
                result = autolinker_1.default.link(inputStr, { newWindow: false, hashtag: 'twitter', mention: 'instagram' });
                expect(result).toBe([
                    'Website: <a href="http://asdf.com">asdf.com</a>',
                    'EmailMatch: <a href="mailto:asdf@asdf.com">asdf@asdf.com</a>',
                    'Phone: <a href="tel:1234567890">(123) 456-7890</a>',
        ...
        describe("`replaceFn` option", function () {
            var returnTrueFn = function () { return true; }, returnFalseFn = function () { return false; }, replaceFnSpy;
            beforeEach(function () {
                replaceFnSpy = jasmine.createSpy('replaceFnSpy');
            });
            it("by default, should be called with with the `Autolinker` instance " +
                "as the context object (`this` reference)", function () {
                var replaceFnAutolinker = new autolinker_1.default({
            ...
            it("when provided a `context` option, should be called with with " +
                "that object as the context object (`this` reference)", function () {
            ...
            it("should populate a UrlMatch object with the appropriate properties", function () {
                ...
                var result = autolinker_1.default.link("Website: asdf.com ", {
            ...
            it("should populate an EmailMatch object with the appropriate properties", function () {
                var replaceFnCallCount = 0;
                var result = autolinker_1.default.link("EmailMatch: asdf@asdf.com ", {
                    replaceFn: function (match) {
                        replaceFnCallCount++;
            ...
            it("should populate a HashtagMatch object with the appropriate properties", function () {
                var replaceFnCallCount = 0;
                var result = autolinker_1.default.link("HashtagMatch: #myHashtag ", {
                    hashtag: 'twitter',
                    replaceFn: function (match) {
                        replaceFnCallCount++;
            ...
            it("should populate a TwitterMatch object with the appropriate properties", function () {
                var replaceFnCallCount = 0;
                var result = autolinker_1.default.link("Twitter: @myTwitter ", {
                    mention: 'twitter',
                    replaceFn: function (match) {
                        replaceFnCallCount++;
            ...
            it("should populate a MentionMatch object with the appropriate properties", function () {
                var replaceFnCallCount = 0;
                var result = autolinker_1.default.link("Mention: @myTwitter ", {
                    mention: 'twitter',
                    replaceFn: function (match) {
                        replaceFnCallCount++;
                        expect(match.getMatchedText()).toBe('@myTwitter');
            ...
            it("should replace the match as Autolinker would normally do when `true` is returned from the `replaceFn`", function () {
                var result = autolinker_1.default.link("Website: asdf.com, EmailMatch: asdf@asdf.com, Twitter: @asdf", {
                    mention: 'twitter',
                    newWindow: false,
            ...
            it("should not drop a trailing parenthesis of a URL match if the `replaceFn` returns false", function () {
                var result = autolinker_1.default.link("Go to the website (asdf.com) and see", {
                    newWindow: false,
                    replaceFn: returnFalseFn
                });
            ...
            describe('special cases which check the `prefixStr` and `suffixStr` vars in the code', function () {
                it("should leave the match as-is when the `replaceFn` returns `false` for a Twitter match", function () {
                    var result = autolinker_1.default.link("@asdf", { replaceFn: returnFalseFn });
                    expect(result).toBe("@asdf");
                    var result2 = autolinker_1.default.link("Twitter: @asdf", { mention: 'twitter', replaceFn: returnFalseFn });
                ...
                it("should leave the match as-is when the `replaceFn` returns `false`, and the URL was wrapped in parenthesis", function () {
                    var result = autolinker_1.default.link("Go to (yahoo.com) my friend", { replaceFn: returnFalseFn });
                    expect(result).toBe("Go to (yahoo.com) my friend");
                    var result2 = autolinker_1.default.link("Go to en.wikipedia.org/wiki/IANA_(disambiguation) my friend", { replaceFn: returnFalseFn });
                    expect(result2).toBe("Go to en.wikipedia.org/wiki/IANA_(disambiguation) my friend");
                    var result3 = autolinker_1.default.link("Go to (en.wikipedia.org/wiki/IANA_(disambiguation)) my friend", { replaceFn: returnFalseFn });
    ...
    describe('all match types tests', function () {
        ...
        it('should replace matches appropriately in a paragraph of text, using a variety of enabled matchers. Want to make sure that when one match type is disabled (such as emails), that other ones don\'t accidentally link part of them (such as from the url matcher)', function () {
            ...
            for (var i = 0, len = Math.pow(2, numTestCaseKeys); i < len; i++) {
                ...
                var autolinker = new autolinker_1.default({
                    urls: {
                ...
                var result = autolinker.link(sourceParagraph), resultLines = result.split('\n'), // splitting line-by-line to make it easier to see where a failure is
        ...
        it("should be able to parse a very long string", function () {
            ...
            var result = autolinker_1.default.link(testStr);
            expect(result).toBe(testStr);
        });
    });
    describe('static parse()', function () {
        it('should return an array of Match objects for the input', function () {
            ...
            var matches = autolinker_1.default.parse(text, {
                hashtag: 'twitter',
                mention: 'twitter'
            });
        ...
        xdescribe('custom Phone.prototype.matcherRegex', function () {
            ...
            beforeEach(function () {
                var phoneInTextRegex = /(\+?852\-?)?[569]\d{3}\-?\d{4}/g;
