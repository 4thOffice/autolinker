...
var truncate_middle_1 = require("../../src/truncate/truncate-middle");
/*
 * Date: 2015-10-05
...
describe("Truncate.truncate.truncateMiddle", function () {
    it("Will not truncate a URL if 'truncateLen' is greater", function () {
        var truncatedUrl = truncate_middle_1.truncateMiddle("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 999, "..");
    ...
    it("Will truncate a simple URL correctly", function () {
        var truncatedUrl = truncate_middle_1.truncateMiddle("http://www.yahoo.com/some/long/path/to/a/file?foo=bar?ignorethis#baz=bee", 60, "..");
    ...
    it("Will truncate a very short URL correctly", function () {
        var truncatedUrl = truncate_middle_1.truncateMiddle("yahoo.com", 4, "..");
        expect(truncatedUrl).toBe("y..m");
        expect(truncatedUrl.length).toBe(4);
    });
    it("Will truncate a long URL correctly", function () {
        var truncatedUrl = truncate_middle_1.truncateMiddle("https://www.google.com/search?q=cake&safe=off&es_sm=93&tbas=0&tbs=qdr:d,itp:photo,ic:specific,isc:red,isz:l&tbm=isch&source=lnt&sa=X&ved=0CBQQpwVqFQoTCMCUxfOErMgCFeFrcgodUDwD1w&dpr=1&biw=1920&bih=955", 80, "..");
